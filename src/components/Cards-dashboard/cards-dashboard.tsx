...
export default function CardDashboard(props:PropsCard) {
    ...
    return (
        <>
            <div className="flex max-w-[380px] w-full bg-white px-3 py-5 gap-[13px] rounded-[20px]" onClick={props.editProductFunction}>
            ...
            <div className="flex max-w-[380px] w-full bg-white px-3 py-5 gap-[13px] rounded-[20px]" onClick={props.link}>
